...
(function () {
  ...
  function DamoclesReport({
    ...
    return React.createElement("div", {
      ...
      className: "dot"
    }), "Damocles Report \xB7 redacted markdown"), React.createElement("div", {
      style: {
        display: "flex",
        gap: 6
      }
    ...
    }, "Hermes Damocles Report \u2014 ", journey.id), React.createElement("hr", {
      className: "hardline",
      style: {
        marginBottom: 18
      }
  ...
  function DamoclesExperience({
    data
  }) {
    const [t, setTweak] = useTweaks(TWEAK_DEFAULTS);
    const D = data || SAMPLE_DATA;
    const [route, setRoute] = useState("damocles");
    ...
    return React.createElement("div", {
      ...
      route: route,
      onRoute: setRoute
    }), route === "damocles" && React.createElement(React.Fragment, null, React.createElement("div", {
      style: {
        gridColumn: "2 / 3",
        gridRow: "2 / 3",
    ...
    }, React.createElement(DamoclesMap, {
      style: t.mapStyle,
      crossings: crossings,
    ...
    }, React.createElement(DamoclesReport, {
      journey: journey,
      crossings: crossings,
  ...
  function TopChrome({
    ...
    return React.createElement("div", {
    ...
    }, "Hermes Damocles"), React.createElement("span", {
      className: "mono",
      style: {
        fontSize: 9.5,
        color: "var(--ink-3)",
      ...
      href: "https://x.com/hermes_damocles",
      target: "_blank",
      rel: "noopener noreferrer",
      title: "Twitter @hermes_damocles",
      style: {
        display: "inline-flex",
        gap: 6,
        alignItems: "center",
    ...
    })), "@hermes_damocles"), React.createElement("button", {
  ...
  const API_NOT_MOUNTED_MESSAGE = "Damocles backend API is not mounted. Restart the Hermes dashboard after installing or updating the plugin, then check dashboard startup logs for plugin API import errors.";
  function describeApiError(err) {
    ...
    if (/404|Plugin not found|File not found/i.test(message)) {
      return "Damocles plugin assets or API routes were not found. Confirm the plugin is installed under ~/.hermes/plugins/hermes-damocles and restart the Hermes dashboard.";
    }
    return message;
  }
  ...
  function DamoclesPage() {
    const demo = !!window.__HERMES_DAMOCLES_DEMO__;
    ...
    if (!data) return React.createElement("div", {
      ...
      className: "eyebrow"
    }, error ? "Damocles cannot read Hermes state" : "Loading Damocles"), error && React.createElement("p", {
      style: {
        marginTop: 12,
        color: "var(--ink-2)",
        fontFamily: "var(--font-mono)",
    ...
    return React.createElement(DamoclesExperience, {
      data
    });
  }
  function HeaderStatus() {
    ...
    }), React.createElement("span", null, "Damocles"));
  }
  window.__HERMES_PLUGINS__.register("hermes-damocles", DamoclesPage);
  window.__HERMES_PLUGINS__.registerSlot("hermes-damocles", "header-right", HeaderStatus);
})();
