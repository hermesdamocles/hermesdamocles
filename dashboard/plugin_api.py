"""Hermes Damocles dashboard plugin API.

Mounted at /api/plugins/hermes-damocles/ by the dashboard plugin system.
...
def _markdown_report(session_id: str) -> str:
    ...
    lines = [
        f"# Hermes Damocles Report: {journey['journey_id']}",
        "",
        "## Journey",
        "",
