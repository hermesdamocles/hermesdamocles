#!/usr/bin/env python3
"""Dependency-light tests for the Hermes Damocles plugin API helpers."""
...
TEMP_HOME = Path(tempfile.mkdtemp(prefix="hermes-damocles-api-"))
...
def load_plugin_api():
    install_stubs()
    spec = importlib.util.spec_from_file_location("hermes_damocles_plugin_api", ROOT / "dashboard" / "plugin_api.py")
...
def main() -> None:
    ...
    assert_equal(health["plugin"], "hermes-damocles", "health plugin id")
